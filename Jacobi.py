...
while k < 20:
    for i in range(n):
        ...
        data_list.append(xk_1[i])
    k = k+1
    np.set_printoptions(6, floatmode='fixed')

    xk = xk_1.copy()
data_list = np.array(data_list)
leng = data_list.size
data_list = np.reshape(data_list, (20,2))
print(data_list)
cols = ['col1', 'col2', 'col3']
arr = np.array([[1,2,3],[4,5,6]])
print(tabulate(arr, headers = cols, tablefmt = "fancy_grid", showindex = "always"))